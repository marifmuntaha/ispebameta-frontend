            ...
            <PreviewCard className="card-bordered" bodyClass="card-inner-lg">
                <BlockHead>
                    <BlockContent>
                        ...
                        <BlockDes>
                            <p>Buat akun baru ISPEBAMETA APP</p>
                        </BlockDes>
                    </BlockContent>
                </BlockHead>
                <form className="is-alter" onSubmit={(e) => {
                    e.preventDefault();
                    ...
                    <div className="form-group">
                        ...
                        <div className="form-control-wrap">
                            <input
                                ...
                                name="nip"
                                className="form-control-lg form-control"
                                placeholder="Ex. 196405121990011001"
                                onChange={(e) => handleFormInput(e)}
                            />
                        </div>
                    </div>
                    <div className="form-group">
                        <div className="form-label-group">
                            <label className="form-label" htmlFor="institution">Nama Lembaga</label>
                        </div>
                        <div className="form-control-wrap">
                            <input
                                type="text"
                                name="institution"
                                className="form-control-lg form-control"
                                placeholder="Ex. MI Darul Hikmah"
                                onChange={(e) => handleFormInput(e)}
                            />
                        </div>
                    </div>
